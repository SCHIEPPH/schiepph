...
public class HL7ValidatorTest extends TestCase {
    ...
    public static String    xmlData_1 = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"+
            ...
            "        <OBX.7/>\n"+
            "        <OBX.8/>\n"+
            "        <OBX.9>7_ZZ_AA_facility_visit_type </OBX.9>\n"+
            "        <OBX.10/>\n"+
            "        <OBX.11/>\n"+
            "        <OBX.12>\n"+
            "            <OBX.12.1>X </OBX.12.1>\n"+
    ...
    public static final String      pipe_result_5 = "33_ZZ_AA_pulse_oximetry";
    public static final String      xml_result_5 = "33_ZZ_AA_pulse_oximetry";
