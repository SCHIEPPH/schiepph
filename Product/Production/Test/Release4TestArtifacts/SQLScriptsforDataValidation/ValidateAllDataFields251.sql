...
and unique_visiting_id = 'APRN'
and visit_date_time = '20111009025915'
...
where ss_id = ( select ss_id from schiepph.syndromic_surveillance where facility_name='TestAllData2.5.1' )
...
and schiepph.syndromic_surveillance.facility_name='TestAllData2.5.1'
