...
( select ss_id from schiepph.syndromic_surveillance where facility_name ='MultipleInjuryCodes');
...
and ss_id=( select ss_id from schiepph.syndromic_surveillance where facility_name ='MultipleInjuryCodes');
