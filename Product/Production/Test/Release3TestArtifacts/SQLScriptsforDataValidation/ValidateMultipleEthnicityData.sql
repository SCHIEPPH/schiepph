...
( select ss_id from schiepph.syndromic_surveillance where facility_name ='TestMultipleEthnicity');
...
and ss_id=( select ss_id from schiepph.syndromic_surveillance where facility_name ='TestMultipleEthnicity');
