...
and facility_name = 'TestMissingChiefComplaint'
...
where ss_id = ( select ss_id from schiepph.syndromic_surveillance where facility_name='TestMissingChiefComplaint' )
...
# Validate data makes it to the schiepph.chief_complaint table with missing Chief Complaint data:
